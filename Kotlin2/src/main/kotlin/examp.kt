...
class Labs {
    ...
    fun ex1(x: Double, y: Double) {
        ...
        println("Значение выражения равно $function")
        println()
    }
    ...
    fun ex2(a: Int, b: Int, corner: Double) {
        if (a > 0 && b > 0 && corner >= 0) {
            ...
            println("Площадь трапеции равна $result")
        } else {
            println("Неверные значения")
        }
        println()
    }
    ...
    fun ex3(a: Double, b: Double, c: Double) {
        ...
        println("Количество отрицательных чисел равно $result")
        println()
    }
    ...
    fun ex5(k: Int) {
        if (k in 1..11) {
            when (k) {
                1 -> println("Привет, первоклассник")
                2 -> println("Привет, второклассник")
                3 -> println("Привет, третьеклассник")
                4 -> println("Привет, четвероклассник")
                5 -> println("Привет, пятиклассник")
                6 -> println("Привет, шестиклассник")
                7 -> println("Привет, семиклассник")
                8 -> println("Привет, восьмиклассник")
                9 -> println("Привет, девятиклассник")
                10 -> println("Привет, десятиклассник")
                11 -> println("Привет, одиннадцатиклассник")
            }
        } else {
    ...
    fun ex6(n: Int) {
        if (n >= 0) {
            ...
            println("Вы ввели не натуральное число")
        }
        println()
    }
    ...
    fun ex7(n: Int, x: Float) {
        ...
        println("Сумма $n членов ряда равна: $s")
    }
    ...
    fun ex8(m: Int, n: Int, k: Int) {
        ...
        println("Полученная сумма равна: $sum")
    }
}